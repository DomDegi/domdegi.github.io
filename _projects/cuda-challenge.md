...
description: "CUDA C++ kernel engineering: shared-memory tiling, thread coarsening and bank-conflict avoidance for batched matrix multiplication on GPU."
...
> **Source Code:** [View on GitHub](https://github.com/DomDegi/ParallelComputingChallenge1)
